...
export const FALLBACK_POSTS: Post[] = [
  {
    ...
    blocks: [
      ...
      { type: "img", src: IMAGES.coverSystem, alt: "Wireframe of a modular system", caption: "Fig 1. The same component, themed by overriding three custom properties." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "img", src: IMAGES.coverKeyboard, alt: "Macro shot of a mechanical keyboard", caption: "Modes feel physical — like switching contexts on a keyboard." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "img", src: IMAGES.coverPerf, alt: "Server room with light trails", caption: "TTFB matters more than any optimisation you'll do in JS." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "img", src: IMAGES.coverKeyboard, alt: "Single keycap in dramatic light" },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "img", src: IMAGES.coverHandoff, alt: "Open notebook on a desk" },
