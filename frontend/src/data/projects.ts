import type { FileNode } from "@/components/files-tree";
...
export const FALLBACK_PROJECTS: Project[] = [
  {
    ...
    cover: coverSystem, gallery: [coverSystem, coverKeyboard, coverPerf],
  ...
  },
  {
    ...
    cover: coverVanilla, gallery: [coverVanilla, coverKeyboard, coverSystem],
  ...
  },
  {
    ...
    cover: coverPerf, gallery: [coverPerf, coverSystem, coverVanilla],
  ...
  },
  {
    ...
    cover: coverKeyboard, gallery: [coverKeyboard, coverPerf, coverVanilla],
