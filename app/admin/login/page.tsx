...
import { LogIn, ShieldCheck, Github } from "lucide-react"
      ...
      <Reveal>
        <div className="max-w-md w-full glass-card p-10 text-center">
          ...
          <p className="text-foreground-muted text-sm mb-8">
            This area is for the portfolio administrator only. Please sign in with your authorized Google account.
          </p>
          ...
          <p className="mt-8 text-[10px] text-foreground-muted/40 uppercase tracking-[0.2em]">
            Secure Portfolio CMS v2.0
          </p>
        </div>
      </Reveal>
    </div>
