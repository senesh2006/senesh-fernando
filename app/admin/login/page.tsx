...
function LoginFormContent() {
  ...
  return (
    <div className="max-w-md w-full p-10 text-center bg-zinc-950 border border-zinc-800 rounded-3xl shadow-2xl">
      ...
      {errorMessage && (
        <div className="mb-6 flex items-start gap-3 rounded-2xl border border-red-500/30 bg-red-500/10 p-4 text-left text-sm text-red-300">
      ...
      <div className="mt-8 pt-8 border-t border-zinc-800/50">
        <p className="text-xs text-zinc-500 mb-4">
          Authorized: <span className="text-orange-500 font-mono font-bold">@{allowedUsername}</span>
        </p>
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-4 text-left">
          ...
          <code className="block break-all text-[11px] text-orange-500 font-mono">
