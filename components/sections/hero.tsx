...
export function HeroSection() {
  return (
    <section id="about" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-4 sm:px-6 text-center pt-20">
        <div className="animate-fade-in-up">
          <h1 className="text-4xl sm:text-5xl lg:text-[64px] font-semibold tracking-tight text-[#f5ede6] mb-4 leading-tight">
          ...
          <p className="max-w-2xl mx-auto text-[rgba(245,237,230,0.6)] text-base sm:text-lg leading-relaxed mb-10">
